...
public:
   ...
   */
    ...
    virtual std::any visitIntegerReturn(MiniCParser::IntegerReturnContext *context) = 0;

    virtual std::any visitFloatReturn(MiniCParser::FloatReturnContext *context) = 0;

    virtual std::any visitVoidReturn(MiniCParser::VoidReturnContext *context) = 0;
